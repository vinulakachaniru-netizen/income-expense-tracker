  ...
  return (
    <section className="rounded-2xl border border-white/5 bg-white/5 p-6 shadow-xl backdrop-blur-md relative">
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-4">
        ...
        <button
          type="submit"
          className="flex w-full items-center justify-center gap-2 rounded-xl bg-teal px-4 py-3.5 text-sm font-semibold text-white shadow-lg shadow-teal/20 transition-all hover:-translate-y-0.5 hover:bg-teal-dark hover:shadow-teal/40 active:scale-[0.98]"
        >
