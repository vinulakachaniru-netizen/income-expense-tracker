              ...
              >
                <div
                  className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-full ${
                    isIncome ? "bg-emerald-100 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400" : "bg-teal/10 dark:bg-teal/20 text-teal-dark dark:text-teal-light"
                  }`}
                >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="flex h-9 w-9 items-center justify-center rounded-lg text-slate-400 dark:text-slate-500 transition-colors hover:bg-rose-100 dark:hover:bg-rose-500/10 hover:text-rose-600 dark:hover:text-rose-400"
                  >
